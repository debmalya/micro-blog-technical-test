...
function w3DisplayData(id, data) {
    ...
    if (arr.length > 0) {
        ...
        // have to populate blog contents here
        document.getElementById('id01').appendChild(populateBlogList(data.posts));
    }
...
function populateBlogList(blogs) {
        ...
        for (var i = 0; i < blogs.length; i++) {
            ...
            // Set its contents:
            item.appendChild(document.createTextNode(blogs[i].content));
            console.log("Added :" + blogs[i].content);
